  ...
  return (
    <div className="max-w-3xl mx-auto px-5 py-14">
      ...
      <section>
        ...
        <SubSectionTitle>{t('s21Title')}</SubSectionTitle>
        <Body>{t('s21intro')}</Body>
        <BulletList items={t.raw('s21items') as string[]} />

        <SubSectionTitle>{t('s22Title')}</SubSectionTitle>
        <Body>{t('s22p1')}</Body>
        <BulletList items={t.raw('s22items') as string[]} />
        <Body>{t('s22p2')}</Body>

        <SubSectionTitle>{t('s23Title')}</SubSectionTitle>
        <Body>{t('s23intro')}</Body>
        <BulletList items={t.raw('s23items') as string[]} />

        <SubSectionTitle>{t('s24Title')}</SubSectionTitle>
        <Body>{t('s24p1')}</Body>
        <BulletList items={t.raw('s24items') as string[]} />
        <Body>{t('s24p2')}</Body>
      </section>
      ...
      <section>
        ...
        <Body>
          <strong className="text-content-primary">{t('s5p1')}</strong>
        </Body>
        <Body>{t('s5intro')}</Body>
        <BulletList items={t.raw('s5items') as string[]} />
      </section>
      ...
      <section>
        ...
        <Body>
          {t('s9p1')}{' '}
          <a
            href="mailto:soporte@pricentrix.com"
            className="text-brand-600 hover:underline font-medium"
          >
            soporte@pricentrix.com
          </a>
        </Body>
      </section>
      ...
      <section>
        ...
        <Body>{t('s11p1')}</Body>
        <BulletList items={t.raw('s11providers') as string[]} />
        <Body>{t('s11p2')}</Body>
      </section>
